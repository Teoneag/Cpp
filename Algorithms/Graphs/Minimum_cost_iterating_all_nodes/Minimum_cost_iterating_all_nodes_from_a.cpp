// Minimum cost to connect all the nodes starting from a specific node
// Modified -  https://www.codingninjas.com/codestudio/library/minimum-cost-to-connect-all-cities
#include <iostream>
#include <vector>
using namespace std;
...
int main() {
    ...
    cout << "The minimum cost to connect all cities = " << primMST(city, n) << endl;
}